...
PROVIDERS: Dict[str, Provider] = {
    ...
    "xandikos": Provider(
        ...
        auth_scheme=AUTH_BASIC,
        secret_kind=SECRET_PASSWORD,
        help_url="https://www.xandikos.org/",
        base_url=None,
        self_hosted=True,
        well_known=True,
        notes="Git-backed CalDAV/CardDAV. Pass --url to the route root (e.g. /dav).",
    ),
    "stalwart": Provider(
        key="stalwart",
        label="Stalwart",
        ...
        auth_scheme=AUTH_BASIC,
        secret_kind=SECRET_PASSWORD,
        help_url="https://stalw.art/docs/collaboration/calendar/",
        base_url=None,
        self_hosted=True,
        well_known=True,
        notes="All-in-one mail/collab server. Pass --url https://your-stalwart.example.",
    ),
    "egroupware": Provider(
        key="egroupware",
        label="EGroupware",
        ...
        auth_scheme=AUTH_BASIC,
        secret_kind=SECRET_PASSWORD,
        help_url="https://www.egroupware.org/",
        base_url=None,
        path_suffix="/groupdav.php",
        self_hosted=True,
        well_known=True,
        notes="Pass --url https://your-egroupware.example.",
    ),
    "cyrus": Provider(
        key="cyrus",
        label="Cyrus IMAP (JMAP/DAV)",
        backend=BACKEND_CALDAV,
        auth_scheme=AUTH_BASIC,
        secret_kind=SECRET_PASSWORD,
        help_url="https://www.cyrusimap.org/imap/download/installation/http/caldav.html",
        base_url=None,
        path_suffix="/dav",
        self_hosted=True,
        well_known=True,
        notes="Pass --url https://your-cyrus.example.",
    ),
    "zimbra": Provider(
        key="zimbra",
        label="Zimbra",
